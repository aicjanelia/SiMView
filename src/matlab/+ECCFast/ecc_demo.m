...
NoL = 4;  % number of pyramid-levels
...
% Ny=1:A-40;
Nx=1:B; % to avoid "projecting" points outside of support area
Ny=1:A;

% create a template artificially

template_demo = spatial_interp(im_demo, warp_demo, transform, Nx, Ny);
...
image2 = spatial_interp(double(im_demo), final_warp, transform, nx, ny);
